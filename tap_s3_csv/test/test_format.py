...
class TestFormatHandler(unittest.TestCase):
    ...
    #     file_handle = open_file_for_streaming(test_filename, 'rb', newline='\n', errors='surrogateescape')
    ...
    #     file_handle = open_file_for_streaming(test_filename, 'rb', errors='surrogateescape')
    #     iterator = get_filetype_handler(TEST_TABLE_SPEC, file_handle)
    ...
    def test_strip_newlines_local_custom(self):
        ...
        file_handle = open_file_for_streaming(test_filename, 'r', newline='', errors='surrogateescape')
        iterator = get_filetype_handler(TEST_TABLE_SPEC, file_handle)
